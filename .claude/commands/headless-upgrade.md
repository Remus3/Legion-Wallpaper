...
- WAKEUP_NOTES prune: `"C:\Users\Administrator\AppData\Local\Programs\Python\Python314\python.exe" "C:/Legion Wallpaper/scripts/wakeup_prune.py" --keep 3` (no-op when already <=3 sessions; bootstrap the script if absent). Older sessions archive to `docs/history_notes.md`.
